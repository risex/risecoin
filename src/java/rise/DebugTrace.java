...
public final class DebugTrace {
    ...
    static final String QUOTE = Rise.getStringProperty("rise.debugTraceQuote", "");
    static final String SEPARATOR = Rise.getStringProperty("rise.debugTraceSeparator", "\t");
    static final boolean LOG_UNCONFIRMED = Rise.getBooleanProperty("rise.debugLogUnconfirmed");

    static void init() {
        List<String> accountIdStrings = Rise.getStringListProperty("rise.debugTraceAccounts");
        String logName = Rise.getStringProperty("rise.debugTraceLog");
    ...
    private Map<String,String> lessorGuaranteedBalance(Account account, long lesseeId) {
        ...
        map.put("timestamp", String.valueOf(Rise.getBlockchain().getLastBlock().getTimestamp()));
        map.put("height", String.valueOf(Rise.getBlockchain().getHeight()));
    ...
    private Map<String,String> getValues(long accountId, Block block) {
        ...
        map.put("event", "block");
        //map.put("effective balance", String.valueOf(Account.getAccount(accountId).getEffectiveBalanceRISE()));
