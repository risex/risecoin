...
import static rise.user.JSONResponses.DENY_ACCESS;
import static rise.user.JSONResponses.INCORRECT_REQUEST;
import static rise.user.JSONResponses.POST_REQUIRED;

public final class UserServlet extends HttpServlet  {

    abstract static class UserRequestHandler {
        abstract JSONStreamAware processRequest(HttpServletRequest request, User user) throws RiseException, IOException;
        boolean requirePost() {
            return false;
        }
    }

    private static final boolean enforcePost = Rise.getBooleanProperty("rise.uiServerEnforcePOST");
    ...
    private void process(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        } catch (RuntimeException|RiseException e) {
