...
import static rise.user.JSONResponses.LOCK_ACCOUNT;
...
public final class UnlockAccount extends UserServlet.UserRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req, User user) throws IOException {
        ...
        if (account == null) {
            ...
            int blockchainHeight = Rise.getBlockchain().getLastBlock().getHeight();
            try (DbIterator<? extends Block> blockIterator = Rise.getBlockchain().getBlocks(account, 0)) {
            ...
            try (DbIterator<? extends Transaction> transactionIterator = Rise.getBlockchain().getTransactions(account, (byte) -1, (byte) -1, 0)) {
