...
final class JSONData {
    ...
    static JSONObject accountBalance(Account account) {
        ...
        if (account == null) {
            ...
            json.put("effectiveBalanceRISE", "0");
            ...
            json.put("effectiveBalanceRISE", account.getEffectiveBalanceRISE());
    ...
    static JSONObject transaction(Transaction transaction) {
        ...
        json.put("confirmations", Rise.getBlockchain().getHeight() - transaction.getHeight());
