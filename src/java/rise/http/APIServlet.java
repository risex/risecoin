...
import static rise.http.JSONResponses.ERROR_INCORRECT_REQUEST;
import static rise.http.JSONResponses.ERROR_NOT_ALLOWED;
import static rise.http.JSONResponses.POST_REQUIRED;
...
public final class APIServlet extends HttpServlet {
    ...
    abstract static class APIRequestHandler {
        ...
        abstract JSONStreamAware processRequest(HttpServletRequest request) throws RiseException;
    ...
    private static final boolean enforcePost = Rise.getBooleanProperty("rise.apiServerEnforcePOST");
