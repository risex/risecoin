...
public class APITestServlet extends HttpServlet {
    ...
    private static final String header1 =
            ...
            "           <a class=\"navbar-brand\" href=\"/test\">Rise http API</a>" + 
            "       </div>" +
            "       <div class=\"navbar-collapse collapse\">" +
            "           <ul class=\"nav navbar-nav navbar-right\">" +
            "               <li><input type=\"text\" class=\"form-control\" id=\"search\" " + 
            "                    placeholder=\"Search\" style=\"margin-top:8px;\"></li>\n" +
            "               <li><a href=\"https://wiki.risecrypto.org/wiki/Rise_API\" target=\"_blank\" style=\"margin-left:20px;\">Wiki Docs</a></li>" +
            "           </ul>" +
            "       </div>" +
            "   </div>" + 
            "</div>" +
    ...
    private static String form(String requestType, boolean singleView, String className, List<String> parameters, boolean requirePost) {
        ...
        buf.append("<form action=\"/rise\" method=\"POST\" onsubmit=\"return ATS.submitForm(this);\">");
