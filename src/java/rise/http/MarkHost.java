...
import static rise.http.JSONResponses.INCORRECT_DATE;
import static rise.http.JSONResponses.INCORRECT_HOST;
import static rise.http.JSONResponses.INCORRECT_WEIGHT;
import static rise.http.JSONResponses.MISSING_DATE;
import static rise.http.JSONResponses.MISSING_HOST;
import static rise.http.JSONResponses.MISSING_SECRET_PHRASE;
import static rise.http.JSONResponses.MISSING_WEIGHT;
...
public final class MarkHost extends APIServlet.APIRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req) {
        ...
        try {
            ...
            if (weight <= 0 || weight > Constants.MAX_BALANCE_RISE) {
