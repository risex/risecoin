...
import static rise.http.JSONResponses.INCORRECT_MAXNUMBEROFOPTIONS;
import static rise.http.JSONResponses.INCORRECT_MINNUMBEROFOPTIONS;
import static rise.http.JSONResponses.INCORRECT_OPTIONSAREBINARY;
import static rise.http.JSONResponses.INCORRECT_POLL_DESCRIPTION_LENGTH;
import static rise.http.JSONResponses.INCORRECT_POLL_NAME_LENGTH;
import static rise.http.JSONResponses.INCORRECT_POLL_OPTION_LENGTH;
import static rise.http.JSONResponses.MISSING_DESCRIPTION;
import static rise.http.JSONResponses.MISSING_MAXNUMBEROFOPTIONS;
import static rise.http.JSONResponses.MISSING_MINNUMBEROFOPTIONS;
import static rise.http.JSONResponses.MISSING_NAME;
import static rise.http.JSONResponses.MISSING_OPTIONSAREBINARY;
