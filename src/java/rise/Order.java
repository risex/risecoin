...
public abstract class Order {
    ...
    private static void matchOrders(long assetId, Transaction transaction) {
        ...
        while ((askOrder = Ask.getNextOrder(assetId)) != null
            ...
            Trade trade = Trade.addTrade(assetId, Rise.getBlockchain().getLastBlock(), askOrder, bidOrder);
            ...
            askAccount.addTx(Convert.safeMultiply(trade.getQuantityQNT(), trade.getPriceNQT()), transaction.getBlockId(), transaction.getBlockTimestamp(), bidAccount, new Attachment.BurstMiningTransactionCoinAgeReset(transaction.getId()));
        }
    ...
    */
    ...
    public static final class Ask extends Order {
        ...
        static void addOrder(Transaction transaction, Attachment.ColoredCoinsAskOrderPlacement attachment) {
            ...
            matchOrders(attachment.getAssetId(), transaction);
        }
