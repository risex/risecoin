...
public final class Convert {
    ...
    public static String rsAccount(long accountId) {
        return "RISE-" + Crypto.rsEncode(accountId);
    }
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws RiseException.NotValidException {
        if (numBytes > 3 * maxLength) {
            throw new RiseException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseRISE(String rise) {
        return parseStringFraction(rise, 8, Constants.MAX_BALANCE_RISE);
    }
