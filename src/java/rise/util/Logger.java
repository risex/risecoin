...
/**
 * Handle logging for the Rise node server
 */
public final class Logger {
     ...
     * The rise/conf/logging-default.properties and rise/conf/logging.properties configuration
    ...
    static {
        ...
        System.setProperty("java.util.logging.manager", "rise.util.RiseLogManager");
        if (!(LogManager.getLogManager() instanceof RiseLogManager)) {
            System.setProperty("java.util.logging.manager",
                    (oldManager != null ? oldManager : "java.util.logging.LogManager"));
        }
        if (! Boolean.getBoolean("rise.doNotConfigureLogging")) {
            try {
        ...
        log = org.slf4j.LoggerFactory.getLogger(rise.Rise.class);
        enableStackTraces = Rise.getBooleanProperty("rise.enableStackTraces");
        enableLogTraceback = Rise.getBooleanProperty("rise.enableLogTraceback");
    ...
    public static void shutdown() {
        if (LogManager.getLogManager() instanceof RiseLogManager) {
            ((RiseLogManager) LogManager.getLogManager()).riseShutdown();
        }
    }
