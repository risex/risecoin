...
import rise.db.DbVersion;

class RiseDbVersion extends DbVersion {
        ...
        switch (nextUpdate) {
            ...
            case 3:
                apply("CREATE TABLE IF NOT EXISTS transaction (db_id IDENTITY, id BIGINT NOT NULL, "
                        ...
                        + "signature BINARY(64), timestamp INT NOT NULL, type TINYINT NOT NULL, subtype TINYINT NOT NULL, "
            ...
            case 37:
                /*if (!Constants.isTestnet) {
                    apply("INSERT INTO peer (address) VALUES " +
                            "('37.59.121.207'), ('rise.phukhew.com'), ('humanoide.thican.net'), ('108.170.40.4'), ('54.77.63.53'), " +
                            ...
                            "('rise2.achnodes.com'), ('167.206.61.3'), ('81.64.77.101'), ('95.29.201.108'), ('178.162.198.109'), " +
                            ...
                            "('dtodorov.asuscomm.com'), ('178.15.99.67'), ('5.150.195.208'), ('jrise.org'), ('lan.wow64.net'), " +
                            "('198.27.64.207'), ('54.83.4.11'), ('88.163.78.131'), ('risepi.zapto.org'), ('188.226.197.131'), " +
                            "('node7.myrisecoin.org'), ('80.86.92.139'), ('184.164.72.177'), ('rise.hofhom.nl'), ('85.25.198.120'), " +
                            ...
                            "('54.208.32.151'), ('178.33.203.157'), ('176.94.115.161'), ('miasik.no-ip.org'), ('rise1.thican.net'), " +
                            "('109.106.48.104'), ('23.89.192.151'), ('195.154.127.172'), ('ct.flipflop.mooo.com'), ('rise1.achnodes.com'), " +
                            "('rise01.now.im'), ('78.46.92.78'), ('nxs1.hanza.co.id'), ('91.120.22.146'), ('128.199.228.211'), " +
                            ...
                            "('95.24.83.220'), ('gunka.szn.dk'), ('80.153.101.190'), ('rise.cybermailing.com'), ('54.200.116.75'), " +
                            "('84.128.162.237'), ('81.23.22.150'), ('54.213.222.141'), ('185.21.192.9'), ('espo.no-ip.biz'), " +
                            "('174.140.167.239'), ('nacho.damnserver.com'), ('92.222.0.105'), ('risex.ru'), ('188.226.206.41'), " +
                            "('107.170.3.62'), ('211.149.213.86'), ('91.69.121.229'), ('176.9.0.19'), ('188.226.139.71'), " +
                            "('rise.shscrypto.net'), ('46.246.44.104'), ('87.98.163.78'), ('155.133.19.33'), ('195.154.67.124'), " +
                            ...
                            "('37.139.6.166'), ('178.150.207.53'), ('scripterron.dyndns.biz'), ('risenode.hopto.org'), ('66.30.204.105'), " +
                            "('rise.alkeron.com'), ('96.251.124.95'), ('5.45.98.105'), ('rise.sx'), ('76.176.198.6'), ('192.3.158.120'), " +
                            "('83.217.195.132'), ('107.170.164.129'), ('54.68.87.225'), ('sluni.szn.dk'), ('212.47.237.7'), " +
                            "('rise.scryptmh.eu'), ('pakisrise.no-ip.org'), ('85.214.155.115'), ('174.140.166.124'), ('190.10.9.166'), " +
                            ...
                            "('46.237.8.30'), ('37.59.115.207'), ('67.212.71.173'), ('128.199.189.226'), ('node5.myrisecoin.org'), " +
                            "('188.35.156.10'), ('node6.myrisecoin.org'), ('67.212.71.171'), ('84.200.206.220'), ('node1.rise.thican.net'), " +
                            "('oldminersnownodes.ddns.net'), ('90.153.106.133'), ('87.139.122.157'), ('beor.homeip.net'), " +
                            "('192.157.226.151'), ('node4.myrisecoin.org'), ('node0.forgerise.com'), ('63.165.243.112'), ('23.88.104.225')");
                } else {
                    apply("INSERT INTO peer (address) VALUES " +
                            "('rise.scryptmh.eu'), ('54.186.98.117'), ('178.150.207.53'), ('192.241.223.132'), ('node9.myrisecoin.org'), " +
                            "('node10.myrisecoin.org'), ('node3.myrisecoin.org'), ('109.87.169.253'), ('risenet.fr'), ('50.112.241.97'), " +
            ...
            case 141:
            	apply("CREATE INDEX IF NOT EXISTS transaction_recipient_id_height_idx ON transaction (recipient_id, height DESC)");
            case 142:
                return;
            default:
