...
public interface Attachment extends Appendix {
    ...
    abstract static class AbstractAttachment extends AbstractAppendix implements Attachment {
        ...
        @Override
        final void validate(Transaction transaction) throws RiseException.ValidationException {
    ...
    public final static class MessagingAliasAssignment extends AbstractAttachment {
        ...
        MessagingAliasAssignment(ByteBuffer buffer, byte transactionVersion) throws RiseException.NotValidException {
            super(buffer, transactionVersion);
    ...
    public final static class MessagingAliasSell extends AbstractAttachment {
        ...
        MessagingAliasSell(ByteBuffer buffer, byte transactionVersion) throws RiseException.NotValidException {
            super(buffer, transactionVersion);
    ...
    public final static class MessagingAliasBuy extends AbstractAttachment {
        ...
        MessagingAliasBuy(ByteBuffer buffer, byte transactionVersion) throws RiseException.NotValidException {
            super(buffer, transactionVersion);
            this.aliasName = Convert.readString(buffer, buffer.get(), Constants.MAX_ALIAS_LENGTH);
        }
    ...
    public final static class MessagingPollCreation extends AbstractAttachment {
        ...
        MessagingPollCreation(ByteBuffer buffer, byte transactionVersion) throws RiseException.NotValidException {
            super(buffer, transactionVersion);
            ...
            if (numberOfOptions > Constants.MAX_POLL_OPTION_COUNT) {
                throw new RiseException.NotValidException("Invalid number of poll options: " + numberOfOptions);
            }
    ...
    public final static class MessagingVoteCasting extends AbstractAttachment {
        ...
        MessagingVoteCasting(ByteBuffer buffer, byte transactionVersion) throws RiseException.NotValidException {
            super(buffer, transactionVersion);
            this.pollId = buffer.getLong();
            int numberOfOptions = buffer.get();
            if (numberOfOptions > Constants.MAX_POLL_OPTION_COUNT) {
                throw new RiseException.NotValidException("Error parsing vote casting parameters");
            }
    ...
    public final static class MessagingHubAnnouncement extends AbstractAttachment {
        ...
        MessagingHubAnnouncement(ByteBuffer buffer, byte transactionVersion) throws RiseException.NotValidException {
            super(buffer, transactionVersion);
            this.minFeePerByteNQT = buffer.getLong();
            int numberOfUris = buffer.get();
            if (numberOfUris > Constants.MAX_HUB_ANNOUNCEMENT_URIS) {
                throw new RiseException.NotValidException("Invalid number of URIs: " + numberOfUris);
            }
        ...
        MessagingHubAnnouncement(JSONObject attachmentData) throws RiseException.NotValidException {
            super(attachmentData);
            ...
            try {
                ...
                throw new RiseException.NotValidException("Error parsing hub terminal announcement parameters", e);
            }
        }
    ...
    public final static class MessagingAccountInfo extends AbstractAttachment {
        ...
        MessagingAccountInfo(ByteBuffer buffer, byte transactionVersion) throws RiseException.NotValidException {
            super(buffer, transactionVersion);
    ...
    public final static class ColoredCoinsAssetIssuance extends AbstractAttachment {
        ...
        ColoredCoinsAssetIssuance(ByteBuffer buffer, byte transactionVersion) throws RiseException.NotValidException {
            super(buffer, transactionVersion);
    ...
    public final static class ColoredCoinsAssetTransfer extends AbstractAttachment {
        ...
        ColoredCoinsAssetTransfer(ByteBuffer buffer, byte transactionVersion) throws RiseException.NotValidException {
            super(buffer, transactionVersion);
    ...
    public final static class DigitalGoodsListing extends AbstractAttachment {
        ...
        DigitalGoodsListing(ByteBuffer buffer, byte transactionVersion) throws RiseException.NotValidException {
            super(buffer, transactionVersion);
    ...
    public final static class DigitalGoodsDelivery extends AbstractAttachment {
        ...
        DigitalGoodsDelivery(ByteBuffer buffer, byte transactionVersion) throws RiseException.NotValidException {
            super(buffer, transactionVersion);
    ...
    public final static class BurstMiningTransactionCoinAgeReset extends AbstractAttachment {
    	
    	private final long txid;
    	
    	BurstMiningTransactionCoinAgeReset(ByteBuffer buffer, byte transactionVersion) {
    		super(buffer, transactionVersion);
    		this.txid = buffer.getLong();
    	}
    	
    	BurstMiningTransactionCoinAgeReset(JSONObject attachmentData) {
    		super(attachmentData);
    		this.txid = Convert.parseUnsignedLong((String)attachmentData.get("id"));
    	}
    	
    	public BurstMiningTransactionCoinAgeReset(long txid) {
    		this.txid = txid;
    	}
    	
    	@Override
        String getAppendixName() {
            return "TransactionCoinAgeReset";
        }
        ...
        @Override
        void putMyJSON(JSONObject attachment) {
        	attachment.put("id", Convert.toUnsignedLong(this.txid));
        }

        @Override
        public TransactionType getTransactionType() {
            return TransactionType.BurstMining.TRANSACTION_COIN_AGE_RESET;
        }
    }
}
