...
public final class Hallmark {
    ...
    public static String generateHallmark(String secretPhrase, String host, int weight, int date) {
        ...
        if (weight <= 0 || weight > Constants.MAX_BALANCE_RISE) {
            throw new IllegalArgumentException("Weight should be between 1 and " + Constants.MAX_BALANCE_RISE);
        }
    ...
    public static Hallmark parseHallmark(String hallmarkString) {
        ...
        boolean isValid = host.length() < 100 && weight > 0 && weight <= Constants.MAX_BALANCE_RISE
