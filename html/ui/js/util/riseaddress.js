/*
    RISE address class, extended version (with error guessing).

    Version: 1.0, license: Public Domain, coder: RiseChg (admin@risechg.com).
*/

function RiseAddress() {
	...
	this.set = function(adr, allow_accounts) {
		...
		if (adr.indexOf('RISE-') == 0) adr = adr.substr(5);
