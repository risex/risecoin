							...
							if (!response.errorCode) {
								if (transaction.recipient != response.buyer || transaction.attachment.priceNQT != response.priceNQT) {
									...
									message = $.t("alias_sale_direct_offer", {
										"rise": NRS.formatAmount(transaction.attachment.priceNQT)
				...
				case 2:
					...
					NRS.sendRequest("getAsset", {
						...
						var data = {
							...
							"asset_name": asset.name,
							"quantity": [transaction.attachment.quantityQNT, asset.decimals],
							"price_formatted_html": NRS.formatOrderPricePerWholeQNT(transaction.attachment.priceNQT, asset.decimals) + " RISE",
							"total_formatted_html": NRS.formatAmount(NRS.calculateOrderTotalNQT(transaction.attachment.quantityQNT, transaction.attachment.priceNQT)) + " RISE"
						};
				...
				case 2:
					...
					NRS.sendRequest("getDGSGood", {
						...
						var data = {
							...
							"item_name": goods.name,
							"new_price_formatted_html": NRS.formatAmount(transaction.attachment.priceNQT) + " RISE",
							"seller": NRS.getAccountFormatted(goods, "seller")
						};
					...
					NRS.sendRequest("getDGSPurchase", {
						...
						NRS.sendRequest("getDGSGood", {
							...
							if (purchase.quantity != "1") {
								...
								data["total_formatted_html"] = orderTotal + " RISE";
							}
				...
				case 7:
					...
					NRS.sendRequest("getDGSPurchase", {
						...
						NRS.sendRequest("getDGSGood", {
							...
							data["order_total_formatted_html"] = NRS.formatAmount(orderTotal) + " RISE";
