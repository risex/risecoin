...
var NRS = (function(NRS, $, undefined) {
	...
	$(".modal").on("hidden.bs.modal", function(e) {
		...
		var $feeInput = $(this).find("input[name=feeRISE]");
		...
		if ($feeInput.length) {
			...
			$(this).find(".advanced_fee").html(NRS.formatAmount(NRS.convertToNQT(defaultFee)) + " RISE");
		}
	...
	$("input[name=feeRISE]").on("change", function() {
		var $modal = $(this).closest(".modal");

		var $feeInfo = $modal.find(".advanced_fee");

		if ($feeInfo.length) {
			$feeInfo.html(NRS.formatAmount(NRS.convertToNQT($(this).val())) + " RISE");
		}
	});
