...
var NRS = (function(NRS, $, undefined) {
	...
	NRS.genesisRS = "RISE-MRCC-2YLS-8M54-3CMAJ";
	...
	NRS.init = function() {
		...
		$("#dgs_search_account_top, #dgs_search_account_center").mask("RISE-****-****-****-*****", {
			"unmask": false
		});
	...
	NRS.updateAccountLeasingStatus = function() {
		...
		if (NRS.accountInfo.effectiveBalanceRISE == 0) {
